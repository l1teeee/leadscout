  ...
  return (
    ...
    >
      <nav className="mx-auto flex h-full w-full max-w-7xl items-center justify-between gap-3 px-4 sm:px-6 lg:px-8">
        ...
        <Link href="/landing" className="flex items-center gap-3" aria-label="LeadScout landing">
          <div
        ...
        <div className="flex shrink-0 items-center gap-2">
          <Link
            href="/login"
            className="lnd-link-ghost inline-flex h-9 items-center justify-center px-3 text-xs font-bold active:translate-x-0.5 active:translate-y-0.5"
            style={{
              ...bodyFont,
              color: "#D4D4D8",
            }}
