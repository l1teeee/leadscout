...
export const SETTINGS_WORKSPACE: WorkspaceAgency = {
  ...
  status: "activo",
  industry: "Agencia de marketing y prospección B2B",
  country: "El Salvador",
  city: "San Salvador",
  address: "Colonia Escalón, 79 Avenida Norte, San Salvador",
  phone: "+503 2223-4180",
...
export const SETTINGS_WORK_ZONES: WorkZone[] = [
  {
    ...
    activeAgents: 2,
    categories: ["Restaurantes", "Clínicas", "Retail", "Servicios profesionales"],
    notes: "Zona principal para cuentas con alta urgencia digital y presencia local activa.",
  },
  {
    id: "zone-santa-tecla",
    name: "Santa Tecla y Antiguo Cuscatlán",
    department: "La Libertad",
    municipalities: ["Santa Tecla", "Antiguo Cuscatlán", "Nuevo Cuscatlán"],
    priority: "alta",
    radiusKm: 14,
    monthlyLeadTarget: 95,
    activeAgents: 2,
    categories: ["Cafeterías", "Bienes raíces", "Educación", "Salud"],
    notes: "Buen potencial para paquetes premium de sitio web, pauta y automatización.",
  },
  {
    id: "zone-la-libertad",
    name: "Costa La Libertad",
    department: "La Libertad",
    municipalities: ["La Libertad", "Tamanique", "Chiltiupán"],
    priority: "media",
    radiusKm: 32,
  ...
  },
  {
    ...
    activeAgents: 1,
    categories: ["Automotriz", "Ferreterías", "Clínicas", "Comercio local"],
    notes: "Mercado estable para auditorías de Google Business Profile y landing pages.",
  },
  {
    id: "zone-san-miguel",
  ...
  {
    id: "zone-usulutan",
    name: "Usulután y Bahía de Jiquilisco",
    department: "Usulután",
    municipalities: ["Usulután", "Puerto El Triunfo", "Jiquilisco"],
    priority: "baja",
    radiusKm: 30,
    monthlyLeadTarget: 35,
    activeAgents: 1,
    categories: ["Turismo", "Agronegocios", "Restaurantes", "Servicios locales"],
    notes: "Zona secundaria para exploración; validar demanda antes de abrir campañas masivas.",
  },
];
